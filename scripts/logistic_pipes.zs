...
//Raw FPGA Chipset
recipes.addShaped(<logisticspipes:chip_fpga_raw> * 24, [[<ore:sand>, <buildcraftsilicon:redstone_chipset:4>, <ore:sand>],[<buildcraftsilicon:redstone_chipset:2>, <buildcraftsilicon:redstone_chipset>, <buildcraftsilicon:redstone_chipset:2>], [<ore:sand>, <ore:dustLapis>, <ore:sand>]]);